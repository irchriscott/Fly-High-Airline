<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BusinessService.aspx.cs" Inherits="FlyHighAirlines.BusinessService" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Fly High Airline - Business Service</title>
    <meta charset="utf-8" />
...
<body>
    ...
    <div>
        ...
        <div class="customers_list_div">
            ...
            <br />
            <div>
                <asp:GridView ID="business_service_customers" AutoGenerateSelectButton="true" CssClass="customers_table" runat="server" OnSelectedIndexChanged="business_service_customers_SelectedIndexChanged"></asp:GridView>
            </div>
        </div>
        <div class="add_details">
            ...
            <p><strong>Start Date : </strong><span id="start_date" runat="server"></span></p>
            <p><strong>End Date: </strong><span id="end_date" runat="server"></span></p>
            <p><strong>Product : </strong><span id="product" runat="server"></span></p>
            <p><strong>Quantity : </strong><span id="quantity" runat="server"></span></p>
