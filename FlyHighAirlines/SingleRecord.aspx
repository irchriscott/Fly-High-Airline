<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SingleRecord.aspx.cs" Inherits="FlyHighAirlines.SingleRecord" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Fly High Airline - Single Record</title>
    <meta charset="utf-8" />
    ...
    <div>
        ...
        <div class="customers_list_div">
            ...
            <div class="search_date">
                <input type="text" runat="server" id="search_by_id" placeholder="&#xF002; Search By Document ID" />
                <asp:Button ID="search_now" runat="server" CssClass="search_button" Text="&#xF002;" OnClick="search_now_Click" />
            </div>
            <br />
            <div>
                <asp:GridView ID="single_record_table" CssClass="customers_table"  runat="server"></asp:GridView>
            </div>
        </div>
        <div class="add_details">
            ...
            <asp:Image ID="customer_avatar" CssClass="sel_cus_av" runat="server" />
            <p><strong>First Name : </strong><span runat="server" id="first_name"></span></p>
            ...
            <p><strong>Registration Date : </strong><span id="registration_date" runat="server"></span></p>
            <p><strong>Travel : <span runat="server" id="travel_service"></span></strong></p>
            <p><strong>Tour : <span runat="server" id="tour_service"></span></strong></p>
            <p><strong>Transfert : <span runat="server" id="transfert_service"></span></strong></p>
            <p><strong>Business : <span runat="server" id="business_service"></span></strong></p>
        </div>
    </div>
    </form>
</body>
