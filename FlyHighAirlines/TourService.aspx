<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TourService.aspx.cs" Inherits="FlyHighAirlines.TourService" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Fly High Airline - Tour Service</title>
    <meta charset="utf-8" />
...
<body>
    ...
    <div>
        ...
        <div class="customers_list_div">
            ...
            <br />
            <div>
                <asp:GridView ID="tour_service_customers" AutoGenerateSelectButton="true" CssClass="customers_table" runat="server" OnSelectedIndexChanged="tour_service_customers_SelectedIndexChanged"></asp:GridView>
            </div>
        </div>
        <div class="add_details">
            ...
            <p><strong>Place Visited : </strong><span id="place_visited" runat="server"></span></p>
